...
<link href="css/style.css" rel='stylesheet' type='text/css' />
 ...
 <meta name="keywords" content="jeet Gurjar, web Developer, web Designer" />
<!-- webfonts -->
		...
		<!-- container -->
			...
			<div id="home" class="header">
				...
				<div class="top-header">
					...
					<div class="logo">
						<h1><a href="index.html"><span>Cj</span></a></h1>
					</div>
			...
			<div class="banner-info">
				<div class="col-md-7 header-right">
					<h1>Hi !</h1>
					<h6>I'M WEB DEVELOPER & DESIGNER</h6>
					<ul class="address">
					
					<li>
							<ul class="address-text">
								<li><b>NAME</b></li>
								<li>I'M JEET GURJAR</li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
						...
						<li>
							<ul class="address-text">
								<li><b>ADDRESS </b></li>
								<li>648/8 Nanda Nagar Indore, india</li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>E-MAIL </b></li>
								<li><a href="mailto:jeetgurjar2126@gmail.com"> jeetgurjar2126@gmail.com</a></li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>WEBSITE </b></li>
								<li><a href="http://w3layouts.com">www.creativejeet.tk</a></li>
							</ul>
						</li>
					...
					<div id="owl-demo1" class="owl-carousel owl-carousel2">
					                <div class="item">
					                	<div class="about-left-grid">
											<h2>Hi!</span></h2>
											<p>I am Jeet Gurjar, a Web Developer & Designer from a glorious city Indore. I am looking for new Job opportunity to work in Web Industry. I can work well with my technical tools - PHP, ANGULAR JS, HTML5, CSS3, Bootstrap, JavaScript, JQuery. The only thing I want is a platform where I can put my skills over there.

											Interested in taking innitiative. Before that Please explore my website</p>
											<ul>
			...
			<div id="services" class="services">
				...
				<div class="col-md-6 wthree_about_right_grid">
					...
					<div class="col-xs-8 wthree_about_right_grid_right">
						...
						<p>I Do Web Development on php and its freamworks.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 wthree_about_right_grid">
					...
					<div class="col-xs-8 wthree_about_right_grid_right">
						<h4>Web Design</h4>
						<p>I'M also a Web Designer who provied a responsive web application designs with creativity</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 wthree_about_right_grid">
					...
					<div class="col-xs-8 wthree_about_right_grid_right">
						<h4>Mobile Apk</h4>
						<p>I'm also convert a Responsive Website Into A Android apk with same functionality</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<!-- <div class="col-md-6 wthree_about_right_grid">
								   ...
								   <div class="clearfix"></div>
					                        ...
					                        <ul class="col-md-6 timeline">
																<li>
																  ...
																  <div class="timeline-panel">
																	<div class="timeline-heading">
																	  <h4 class="timeline-title">Ypsilon IT Solutions</h4>
																	</div>
																	<div class="timeline-body">
																	  <p>I was completed My training in web Development & Design from 1 Nobmber 2017 to 30 March 2018. </p>
																	</div>
																  </div>
																</li>
																...
																<li>
																  ...
																  <div class="timeline-panel">
																	<div class="timeline-heading">
																	  <h4 class="timeline-title">Creato Web It Solutions</h4>
																	</div>
																	<div class="timeline-body">
																	  <p>i was warked here as a Web Developer for four Moths from 1st march 2018 To 1st August 2018.</p>
																	</div>
																  </div>
																</li>
				...
				<div class="sap_tabs">
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						<ul class="resp-tabs-list">
							...
							<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>WEB DEVELOPMENT</span></li> 				
						...
						<div class="resp-tabs-container">
							<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
								<div class="col-md-3 team-gd ">
										...
										<a href="#portfolioModal1" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="images/tubika.png" alt="">
								...
								<div class="col-md-3 team-gd ">
										...
										<a href="#portfolioModal2" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="images/homes.png" alt="">
...
<div class="footer" id="contact">
	...
	<div class="service-head one text-center">
		...
		<div class="copy_right text-center">
			<p>&copy; 2016 Preface . All rights reserved | Design by <a href="http://creativejeet.tk/" target="_blank">Jeet Gurjar.</a></p>
			...
			<div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
						<h3>Tubika Reat Estate</h3>
                        <img src="images/tubika.png" class="img-responsive img-centered" alt="">
                        <p>Tubika is an realestate website.its designed By me At creato web it solutions indore</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-content port-modal">
        ...
        <div class="container">
			<div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
						<h3>Homes Pet Sitter</h3>
                        <img src="images/homes.png" class="img-responsive img-centered" alt="">
                        <p>Homes Is a pet sitter website which is also designed by me  at creato web it solutions indore.its design is on Angular js.</p>
                    </div>
                </div>
            </div>
        </div>
